...
import {deleteBooking, fetchAllAirhockeyBookings} from "../Components/Queries";
import {Button, Table} from "react-bootstrap";
import {Link} from "react-router-dom";
import {useState} from "react";

export const SeeAirhockeyReservation = () =>{

    const[searchTerm, setSearchTerm] = useState("");

    const {data, isLoading, isError} = useQuery("airbookings", fetchAllAirhockeyBookings);
                            ...
                            <tr key={bookings.id}>
                                ...
                                <td>
                                    <Link
                                        ...
                                        to={`/editAirhockeyReservation/${bookings.id}`}>Rediger</Link>
                                </td>
                                <td>
