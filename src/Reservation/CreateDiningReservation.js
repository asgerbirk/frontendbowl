...
import {createDiningReservation} from "../Components/Queries";
import {useState} from "react";


export const CreateDiningReservation = () =>{
    ...
    const {mutate, isError, isLoading} = useMutation(createDiningReservation, {onSuccess: () => {
        ...
        <div className="container" >
            <div className="row">
                <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow" style={{backgroundColor: 'white'}}>
                    <h2 className="text-center m-4">Restaurant reservation</h2>
