...
import {createAirhockeyReservation} from "../Components/Queries";
import {useState} from "react";


export const CreateAirhockeyReservation = () =>{
    ...
    const {mutate, isError, isLoading} = useMutation(createAirhockeyReservation, {onSuccess: () => {
    ...
    const handleSubmit = async (e) =>{
        e.preventDefault();
        mutate({name, email, reservationStart, reservationEnd, numberOfPeople,date,tableNum})
        navigate("/")
    }
        ...
        <div className="container" >
            <div className="row">
                <div className="col-md-6 offset-md-3 border rounded p-4 mt-2 shadow" style={{backgroundColor: 'white'}}>
                    <h2 className="text-center m-4">Airhockey reservation</h2>
                    <form onSubmit={handleSubmit}>
                        ...
                        <div className="mb-3">
                            <label htmlFor="tableNum" className="form-label">
                                Antal baner
                            </label>
                            <input
                                type={"number"}
                                className="form-control"
                                placeholder="Antal borde"
                                name="countOfLanes"
                                value={tableNum}
